...
namespace Content.Client._CMU14.Medical.Machines;
...
public sealed class CMULimbPrinterBui : BoundUserInterface
{
    ...
    protected override void Open()
    {
        ...
        _window.EjectMetalButton.OnPressed += _ => SendMessage(new CMULimbPrinterEjectMetalMessage());
        _window.EjectCableButton.OnPressed += _ => SendMessage(new CMULimbPrinterEjectCableMessage());
    ...
    private void Refresh(CMULimbPrinterBuiState state)
    {
        ...
        _window.MetalTitleLabel.Text = Loc.GetString("cmu-limb-printer-metal-resource");
        _window.CableTitleLabel.Text = Loc.GetString("cmu-limb-printer-cable-resource");
        ...
        _window.MetalLabel.Text = state.MetalName ?? Loc.GetString("cmu-limb-printer-no-metal");
        _window.CableLabel.Text = state.CableName ?? Loc.GetString("cmu-limb-printer-no-cable");
        ...
        _window.MetalAmountLabel.Text = Loc.GetString("cmu-limb-printer-stack-amount", ("current", state.MetalCount));
        _window.CableAmountLabel.Text = Loc.GetString("cmu-limb-printer-stack-amount", ("current", state.CableCount));
        ...
        _window.MetalCostLabel.Text = Loc.GetString("cmu-limb-printer-metal-cost", ("cost", state.MetalCost));
        _window.CableCostLabel.Text = Loc.GetString("cmu-limb-printer-cable-cost", ("cost", state.CableCost));
        ...
        SetBar(_window.MetalBar, state.MetalCount, state.MetalCost);
        SetBar(_window.CableBar, state.CableCount, state.CableCost);

        _window.EjectBeakerButton.Disabled = state.BeakerName is null;
        _window.EjectSyringeButton.Disabled = state.SyringeName is null;
        _window.EjectMetalButton.Disabled = state.MetalName is null;
        _window.EjectCableButton.Disabled = state.CableName is null;
    ...
    private Control BuildOption(CMULimbPrinterOption option)
    {
        ...
        button.OnPressed += _ => SendMessage(new CMULimbPrinterPrintMessage(option.Recipe, option.Type, option.Symmetry));
        return button;
    }
...
public sealed class CMULimbPrinterWindow : FancyWindow
{
    ...
    public Label CableTitleLabel = default!;
    public Label BeakerLabel = default!;
    public Label SyringeLabel = default!;
    public Label MetalLabel = default!;
    public Label CableLabel = default!;
    public Label MatrixAmountLabel = default!;
    public Label BloodAmountLabel = default!;
    public Label MetalAmountLabel = default!;
    public Label CableAmountLabel = default!;
    public Label MatrixCostLabel = default!;
    public Label BloodCostLabel = default!;
    public Label MetalCostLabel = default!;
    public Label CableCostLabel = default!;
    public ProgressBar MatrixBar = default!;
    public ProgressBar BloodBar = default!;
    public ProgressBar MetalBar = default!;
    public ProgressBar CableBar = default!;
    public Button EjectBeakerButton = default!;
    public Button EjectSyringeButton = default!;
    public Button EjectMetalButton = default!;
    public Button EjectCableButton = default!;
    ...
    private Control BuildRoot()
    {
        ...
        var solids = new BoxContainer
        {
            Orientation = BoxContainer.LayoutOrientation.Horizontal,
            SeparationOverride = 8,
            HorizontalExpand = true,
        };
        root.AddChild(solids);
        solids.AddChild(BuildFluidPanel(
            Loc.GetString("cmu-limb-printer-metal-heading"),
            CMUMedicalMachineStyle.Cyan,
            out MetalTitleLabel,
            out MetalLabel,
            out MetalAmountLabel,
            out MetalCostLabel,
            out MetalBar,
            out EjectMetalButton,
            Loc.GetString("cmu-limb-printer-remove-metal")));
        solids.AddChild(BuildFluidPanel(
            Loc.GetString("cmu-limb-printer-cable-heading"),
            CMUMedicalMachineStyle.Cyan,
            out CableTitleLabel,
            out CableLabel,
            out CableAmountLabel,
            out CableCostLabel,
            out CableBar,
            out EjectCableButton,
            Loc.GetString("cmu-limb-printer-remove-cable")));
