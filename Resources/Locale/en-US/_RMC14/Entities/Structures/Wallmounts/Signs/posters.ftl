...
ent-CMPosterElectroMan = Electro Gold
    .desc = Electro Golds - lovingly machine rolled for YOUR pleasure.
...
ent-CMPosterNoSmoking2 = NO SMOKING
    .desc = A warning sign which reads 'NO SMOKING'.
...
ent-CMPosterSPP12 = The Stars Are Ours
    .desc = A stylized depiction of the UPP home system and the stars
...
ent-CMPosterSPP9 = Ever Vigilant Against Capitalist Forces
    .desc = A warped screaming eagle made to look like a vulture bears its talons over the UPP homeworld which has the UPP roundel super-imposed over it. The poster reads, 'The UN will not break the resolve of the people.'
...
ent-RMCPosterWEYA3 = Weston-Yamada poster
    .desc = A Weston-Yamada logo featuring a stylized wireframe planet and the company slogan: The Future is Now.
