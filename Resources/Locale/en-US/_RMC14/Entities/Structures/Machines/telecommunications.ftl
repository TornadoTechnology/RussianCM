ent-RMCBlackMPSComputer = computer
...
ent-RMCBlackSensorComputer = computer
    .desc = The IBM series 10 computer retrofitted to work as a sensor computer for the ship. While somewhat dated it still serves its purpose.

ent-RMCBlackSensorComputer2 = computer
    .desc = The IBM series 10 computer retrofitted to work as a sensor computer for the ship. While somewhat dated it still serves its purpose.

ent-RMCBlackSensorComputer3 = computer
    .desc = The IBM series 10 computer retrofitted to work as a sensor computer for the ship. While somewhat dated it still serves its purpose.
...
ent-RMCTelecomBlackBoxDD = Blackbox Recorder
    .desc = The blackbox recorder is a device used to record data from the ship's systems. It is designed to be tamper-proof and can withstand extreme conditions.
    .suffix = DrawDepth
...
ent-RMCTelecomBroadcasterDD = Subspace Broadcaster
    .desc = A dish-shaped machine used to broadcast processed subspace signals.
    .suffix = DrawDepth
...
ent-RMCTelecomProcessorUnitDD = Processor Unit
    .desc = This machine is used to process large quantities of information.
    .suffix = DrawDepth
...
ent-RMCTelecomRelayDD = Telecomms Relay
    .desc = A mighty piece of hardware used to send massive amounts of data far away.
    .suffix = DrawDepth
...
ent-RMCWhiteMPSComputer = computer
    .desc = The IBM series 10 computer retrofitted to work as a sensor computer for the ship. While somewhat dated it still serves its purpose.

ent-RMCWhiteMappingComputer = computer
    .desc = The IBM series 10 computer retrofitted to work as a sensor computer for the ship. While somewhat dated it still serves its purpose.

ent-RMCWhiteSensorComputer = computer
    .desc = The IBM series 10 computer retrofitted to work as a sensor computer for the ship. While somewhat dated it still serves its purpose.

ent-RMCWhiteSensorComputer2 = computer
    .desc = The IBM series 10 computer retrofitted to work as a sensor computer for the ship. While somewhat dated it still serves its purpose.

ent-RMCWhiteSensorComputer3 = computer
    .desc = The IBM series 10 computer retrofitted to work as a sensor computer for the ship. While somewhat dated it still serves its purpose.
