ent-RCMWallShivaFab = prefabricated structure wall
    .desc = This structure is made of metal support rods and robust poly-kevlon plastics. A derivative of the stuff used in UN ballistics vests, USCMC and UPP uniforms. These walls are pulled taut and have been reinforced into a more permanent structure.
