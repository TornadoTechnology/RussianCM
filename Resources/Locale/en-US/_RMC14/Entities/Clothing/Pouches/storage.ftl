ent-AU14PouchCommandFill = command pouch
...
ent-RMCPouchCommandFill = command pouch
    .desc = A specialized, sturdy pouch issued to Commanding Officers. Can hold their sidearm, the command tablet and a set of binoculars.
    .suffix = Filled
...
ent-RMCPouchMagazineLargeMAR40 = large magazine pouch
    .desc = It can carry many magazines.
    .suffix = Filled, MAR40

ent-RMCPouchMagazineLargePMC = large magazine pouch
    .desc = It can carry many magazines.
    .suffix = PMC
...
ent-RMCPouchMagazinePistolLargeFilledHighCommand = large pistol magazine pouch
    .desc = It can carry many pistol magazines or revolver speedloaders.
...
ent-RMCPouchShotgunLargeBuckshot = large shotgun shell pouch
    .desc = It can contain more handfuls of shells.
...
ent-RMCPouchSurvivalBlack = survival pouch
    .desc = A pouch given to colonists in the event of an emergency.
...
ent-RMCPouchToolsFilledRCM = tools pouch
    .desc = It's designed to hold maintenance tools - screwdriver, wrench, cable coil, etc. It also has a hook for an entrenching tool or light replacer.
    .suffix = Filled, RCM
...
ent-RMCPouchToolsSocFilledSynthetic = tactical tools pouch
    .desc = This particular toolkit full of sharp, heavy objects was designed for breaking into things rather than fixing them. Still does the latter pretty well, though.
    .suffix = Filled, Synthetic

ent-RMCPouchToolsSocFilledTactical = tactical tools pouch
    .desc = This particular toolkit full of sharp, heavy objects was designed for breaking into things rather than fixing them. Still does the latter pretty well, though.
    .suffix = Filled, Tactical

ent-RMCPouchToolsSocRCMPVEAssaultEngi = tactical tools pouch
    .desc = This particular toolkit full of sharp, heavy objects was designed for breaking into things rather than fixing them. Still does the latter pretty well, though.
