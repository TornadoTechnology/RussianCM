ent-RMCBaseFigurinePatron = figurine
...
ent-RMCFigurinePatronAmeliaFields = Amelia Fields figurine
    .desc = A chipped figurine surrounded by dust. Taped to the underside is a yellow sticky note. The first line is neat, the second sloppy. "Not missing." "i put it here." No further explanation is provided.
...
ent-RMCFigurinePatronEinukoTwitchSteelfeather = Einuko 'Twitch' Steelfeather figurine
    .desc = /Made in collaboration with the Avalon Defence Forces./ "Feet first into hell. Always forward. Unto death." "The patron saint of 'Bird JTAC' (and bad ideas.)" A skilled forward observer with several medals for service and military achievements, see box for details. This one comes with an optional parachute attachment stored under the base! /Clip to chest before dropping for best results./ -!!- WARNING - DO NOT IGNITE -!!-
...
ent-RMCFigurinePatronHugs-The-Void = Hugs-The-Void figurine
    .desc = You could swear you've seen this blue lizard before.. but where at? It seems dubious, evil even!.. But with a hint of blueberry fragrance. P.S do not add miniature soap to hands.
...
ent-RMCFigurinePatronIsaakBennett = Isaak Bennett figurine
    .desc = This green vulpkanin comes with your standard Logistics Officer uniform, a perfect companion for any of your logistics needs! Wooden crate accessory sold separately.
...
ent-RMCFigurinePatronKaliDarland = Kali Darland figurine
    .desc = This is a young martian felinid. All craftsmanship is of the highest quality. She holds her rifle slung over her shoulder, striking a smug, triumphant pose. Ninth time's the charm, darling.
...
ent-RMCFigurinePatronMinjiFailsafeKilgrim = Minji 'Failsafe' Kilgrim figurine
    .desc = Some stray cat usually found roaming in medbay. The figure itself smells strongly of various chemicals, small singe marks litter it as if it's been through an explosion or two. If you didn't look closer, you'd mistake the bow and bell decorating her tail for a bee...
...
ent-RMCFigurinePatronMothroach = Luxi La Lustriana figurine
    .desc = At a glance it catches your eye, a strange looking moth... Looking closer, it seems to not just be a moth... but also some sort of insect... Like a moth... roach...? You think a bit more about it... How could it be a moth... and a roach... At the same time? It seems contradictory... Looking at it further... it seems to invoke some emotion... Like... you want to give everything you have to the moth... Your eyes can't look away from it... Drawn to it... like a moth to a flame... How ironic...
...
ent-RMCFigurinePatronSips-On-Puddles = Sips-On-Puddles figurine
    .desc = Floopy ears. Small Snout. Quirky Humour. Half Kobold, All Marine. This is the "Sipper".
...
ent-RMCFigurinePatronZaydenSoapKirkson = Zayden 'Soap' Kirkson figurine
    .desc = Zayden 'Soap' Kirkson Collectible Figurine! From brig bound to shelf ready, this unserious MP is finally here! Rumored to have finally conquered his PTSD, Soap arrives with his trademark stare and his infamous habit of devouring soap..? possibly with unlimited resistance! Get yours today before he eats the rest of the stock!
