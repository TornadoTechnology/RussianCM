ent-AU14MOPPMask = CBRN M3 MOPP mask
...
ent-AU14MaskUSASFPilotOxygen = USASF LAH-99 Oxygen Mask
    .desc = A mask attached to USASF LAH-99 helmets to provide aircrew with breathable oxygen.
