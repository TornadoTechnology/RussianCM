...
ent-AU14ObjectiveItemAIProcessor = AI-процессор
    .desc = Внешний процессор для ИИ, используемый для обработки огромных объемов информации.

ent-AU14ObjectiveItemAtmosphericRadarStorageUnit = Блок хранения атмосферной радиолокационной информации ARCS-9
    .desc = Черный ящик данных, используемый для хранения информации с атмосферных радаров.

ent-AU14ObjectiveItemBlackboxRecorder = Регистратор информации о колонии CIR-60 «черный ящик»
    .desc = Небольшой красный ящик, в котором записываются объявления колонии, графики колонистов и другие ключевые данные. Обычно его называют черным ящиком, хотя этот ящик имеет кроваво-красный цвет.

ent-AU14ObjectiveItemHackableComputer = компьютер для полевых операций
    .desc = Прочный военный ноутбук, содержащий зашифрованные данные связи. Его можно взломать, чтобы получить важную информацию.

ent-AU14ObjectiveItemNuclearLaunchCodes = Буклет с кодами ядерного запуска
    .desc = Высокозасекреченная книга, содержащая коды запуска ядерного оружия.

ent-AU14ObjectiveItemPortableRadioTransceiver = Портативная радиостанция AN/PRC-982
    .desc = Серый радиоприемник, используемый для приема дальней связи. Он также записывает весь получаемый радиотрафик.

ent-AU14ObjectiveItemTheaterHandbook = Справочник по работе театра
    .desc = Высокозасекреченная книга, содержащая боевые планы крупной фракции на нынешнем театре военных действий.

ent-AU14ObjectiveItemWYLaptop = Ноутбук отдела биологического оружия Вейланд-Ютани
    .desc = Портативный компьютер, содержащий данные исследований отдела биологического оружия Вейланд-Ютани.
