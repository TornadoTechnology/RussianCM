...
ent-AU14EncryptionKeyMob = Ключ шифрования семьи мафии
    .desc = Ключ шифрования, используемый для общения на семейном канале.

ent-AU14HeadsetMob = Гарнитура Mob Family
    .desc = Обычная колониальная гарнитура, модифицированная для работы на специальной частоте.
