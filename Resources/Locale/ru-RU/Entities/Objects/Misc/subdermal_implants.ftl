...
ent-ChameleonControllerImplant = Имплант контроллера-хамелеона
    .desc = Этот имплант позволяет мгновенно изменить внешний вид всей надетой одежды-хамелеона.
...
ent-DeathRattleImplantCentcomm = Имплантат предсмертного хрипа Центкомма
    .desc = Этот имплантат сообщит радиоканалу Центкомма, если пользователь попадет в критическое состояние или умрет.
...
ent-FakeMindShieldImplant = фальшивый имплантат ментального щита
    .desc = Этот имплант позволяет имплантатору генерировать ложный сигнал, который службы безопасности NT используют для идентификации людей, которым имплантирован мысленный щит.
...
ent-RadioImplant = радиоимплант
    .desc = Этот имплантат предоставляет доступ к каналу Синдиката без гарнитуры.

ent-RadioImplantCentcomm = радиоимплант
    .desc = Этот имплантат обеспечивает доступ к каналу Центкомма без гарнитуры. Разрешено только сотрудникам Centcomm.
...
ent-TrackingImplant = отслеживающий имплантат
    .desc = Этот имплант имеет устройство слежения, подключенное к сенсорной сети костюма.
