...
ent-BookCafe = кафе опоссум
    .desc = Книга находится в новом состоянии, в яркой и причудливой обложке с очаровательной иллюстрацией крошечного опоссума, выглядывающего из-за чашки кофе, на фоне красочной и шумной сцены кафе. Название «Кафе «Опоссум»» написано жирным игривым шрифтом, а под ним имя автора напечатано более мелким шрифтом.
...
ent-BookIanLostWolfPup = Приключения Йена и Рено - В поисках потерянного волчонка
    .desc = Книга в новом состоянии, с красочной обложкой, на которой изображены корги Йен и лиса Рено, путешествующие по лесу, с потерянным волчонком на ногах. Название «Приключения Яна и Рено — В поисках потерянного волчонка» видно вверху, а имя автора — внизу. Обложка имеет причудливый и авантюрный оттенок, привлекающий читателей всех возрастов.

ent-BookIanMountain = приключения йана и рено - горная экспедиция
    .desc = Книга в новом состоянии. На обложке изображен потрясающий горный пейзаж с Яном и Рено на переднем плане, откуда открывается вид на окружающие вершины и долины. Название написано жирными печатными буквами вверху, подзаголовок «Горная экспедиция» написан внизу.
...
ent-BookMedicalOfficer = Битва горизонта — история медицинского офицера о доверии и выживании
    .desc = На обложке изображен Смит, медицинский офицер, в униформе, выглядящий решительным и готовым принять любой вызов. На заднем плане изображен атакованный SS Horizon, взрывы и дым, заполняющие космическую станцию. На переднем плане виден волшебник с посохом, что добавляет сцене элемент загадочности и интриги. Название выделено жирным шрифтом и содержит имя автора и слоган, указывающий на насыщенный действием и напряженный характер книги.
...
ent-BookNames = сила имен - философское исследование
    .desc = Книга представляет собой философский текст, используемый с осторожностью, на обложке изображен рот человека крупным планом, на губах которого написано слово «имена». Название — «Сила имен — философское исследование», а под ним видно имя автора. Общий дизайн простой и элегантный, с акцентом на текст, а не на яркую графику или изображения.
...
ent-BookSun = тянуться к солнцу – поиск растениями жизни
    .desc = Книга новая, в яркой, яркой обложке с изображением растения, протягивающего листья к солнцу. Название «Достигая Солнца – поиски жизни растения» написано жирными зелеными буквами с изображением солнца, восходящего за растением. Обложка вызывает ощущение роста, энергии и красоты природы.
