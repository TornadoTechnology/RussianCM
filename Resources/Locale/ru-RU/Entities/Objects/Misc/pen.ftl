...
ent-BaseAdvancedPen = ручка
    .desc = Ручка с темными чернилами.

ent-CyberPen = Киберсан ручка
    .desc = Высокотехнологичная ручка прямо из юридического отдела Cybersun, способная преломлять жесткий свет под невозможными углами через свой алмазный наконечник, чтобы писать. Он настолько мощный, что в случае необходимости он даже способен переписать официально проштампованные документы.
...
ent-PenEmbeddable = ручка
    .desc = Ручка с темными чернилами.

ent-PenHop = авторучка Хопа
    .desc = Роскошная перьевая ручка для прохожих на вокзале.

ent-PenWiz = волшебное перо волшебника
    .desc = Роскошная перьевая ручка. Кажется, у него есть волшебный кристаллический ластик.
