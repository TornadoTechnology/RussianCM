...
ent-WeaponRifleAk = АКМС
    .desc = Несколько потрепанная боевая винтовка конструкции, пришедшей со старой Земли. Его предпочитают преступники, ополченцы и террористы из-за его знаменитой надежности и простоты в изготовлении конструкции. Питание осуществляется из винтовочных магазинов калибра .30.

ent-WeaponRifleEstoc = Эсток ДМР
    .desc = Специальная стрелковая винтовка, предназначенная для боя на средних и дальних дистанциях. Использует винтовочные патроны .20.
