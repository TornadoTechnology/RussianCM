...
ent-BaseMagazineBoxLightRifle = ящик для боеприпасов (винтовка .30)

ent-MagazineBoxLightRifle = ящик для боеприпасов (винтовка .30)
    .desc = Картонная коробка с винтовочными патронами .30. Предназначен для хранения кинетических боеприпасов общего назначения.

ent-MagazineBoxLightRifleBig = ящик для боеприпасов (винтовка .30)
    .suffix = Большой

ent-MagazineBoxLightRifleIncendiary = ящик для боеприпасов (зажигательная винтовка .30)
    .desc = Картонная коробка с винтовочными патронами .30. Предназначен для хранения самовоспламеняющихся боеприпасов.

ent-MagazineBoxLightRiflePractice = ящик для боеприпасов (тренировочная винтовка .30)
    .desc = Картонная коробка с винтовочными патронами .30. Предназначен для хранения неопасных меловых боеприпасов.

ent-MagazineBoxLightRifleUranium = Ящик для боеприпасов (винтовочный уран .30)
    .desc = Картонная коробка с винтовочными патронами .30. Предназначен для хранения экзотических боеприпасов с урановым сердечником.
