...
ent-SpeedLoaderLightRifle = скоростной погрузчик (винтовка .30)
    .desc = «Обойма для стриптиза» на 5 патронов для быстрой перезарядки пистолета Кардашева-Мосина. Вмещает 5 патронов для винтовки .30.
