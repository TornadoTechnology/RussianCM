...
ent-WeaponAntiqueLaser = старинный лазерный пистолет
    .desc = Это старинный лазерный пистолет. Все работы высочайшего качества. Он украшен рукояткой из красного дерева и хромированной филигранью. Объект угрожает выбросами энергии. На изделии изображены капитан и клоун. Клоун мертв. Капитан принимает героическую позу.
...
ent-WeaponDisablerSMG = дизейблер ППМ
    .desc = Усовершенствованное оружие, истощающее органические цели, ослабляющее их до тех пор, пока они не разрушатся.
...
ent-WeaponTemperatureGun = температурный пистолет
    .desc = Усовершенствованная пушка, стреляющая лучами, изменяющими температуру тела. Вероятно, это является своего рода военным преступлением.
