...
ent-WeaponImprovisedPneumaticCannonAdmeme = импровизированная пневматическая пушка
    .desc = Импровизировал, используя только трубу, несколько молний и пневматическую пушку. Не принимает баллоны без достаточного количества бензина.
    .suffix = Адмеме

ent-WeaponImprovisedPneumaticCannonGun = импровизированная пневматическая пушка
    .desc = Импровизировал, используя только трубу, несколько молний и пневматическую пушку. Не принимает баллоны без достаточного количества бензина.
    .suffix = Пистолет
