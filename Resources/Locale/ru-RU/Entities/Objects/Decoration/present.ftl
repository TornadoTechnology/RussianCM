...
ent-PresentRandomInsane = подарок
    .desc = Маленькая коробочка с невероятными сюрпризами внутри.
    .suffix = Заполнено, любая сущность

ent-PresentRandomUnsafe = подарок
    .desc = Маленькая коробочка с невероятными сюрпризами внутри.
    .suffix = Заполнено, любой предмет
