...
ent-RefuelingWelder = заправка сварочного инструмента
    .desc = Медленный сварщик, который может со временем дозаправиться.
...
ent-WelderIndustrialAdvanced = усовершенствованный промышленный сварочный инструмент
    .desc = Усовершенствованный промышленный сварочный аппарат с более чем вдвое увеличенным запасом топлива и более горячим пламенем.
