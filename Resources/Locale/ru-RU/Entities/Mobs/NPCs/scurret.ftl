...
ent-MobBaseEmotionalSupportScurret = Эмоциональная поддержка
    .desc = Генетический двуногий предок... Э... Что-то. Да, на станции определенно есть что-то, что произошло от чего бы то ни было.
    .suffix = AI

ent-MobBaseScurret = бежать
    .desc = Генетический двуногий предок... Э... Что-то. Да, на станции определенно есть что-то, что произошло от чего бы то ни было.
    .suffix = AI

ent-MobEmotionalSupportScurret = Эмоциональная поддержка
    .desc = Эти твари, широко известные как Вава, из водно-болотных угодий планеты Вава, составляют основную часть «верной рабочей силы» Arnold's Pizza. Этот здесь временно.
    .suffix = AI

ent-MobScurret = бежать
    .desc = Эти твари, широко известные как Вава, из водно-болотных угодий планеты Вава, составляют основную часть «верных сотрудников Arnolds's Pizza».
    .suffix = AI
