...
ent-ClothingBackpackHarmpack = H.A.R.M.P.A.C.K.
    .desc = Теперь вы можете перезаряжаться, пробивать удары и перекусывать — одновременно.

ent-ClothingBackpackWaterTank = резервуар для воды рюкзака
    .desc = Удерживает большое количество жидкости. Поставляется с распылительными форсунками в ваших руках и имеет прорезь сбоку для указанных распылительных форсунок.

ent-ClothingBagPet = сумка для домашних животных
