...
ent-ClothingHeadHelmetScrap = металлолом шлем
    .desc = Слепленный шлем из тросов, стали и ведра.

ent-SlicedBucketBase = нарезанное ведро
    .desc = Ведро со смотровой щелью, прорезанной сбоку.

ent-SteelBucketBase = стальное ведро
    .desc = Ведро, к которому снаружи приварена сталь. Прежде чем его можно будет носить с комфортом, требуется лучшая форма.

ent-WiredBucketBase = проводное ведро
    .desc = Ведро с прикрепленной проводкой, которая лучше служит подбородочным ремнем.
