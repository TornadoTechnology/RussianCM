...
ent-ClothingEyesEyepatchHudBeerFlipped = повязка на глаз для пива
    .desc = Пара санхудов, оснащенных аппаратурой для сканирования реагентов, а также обеспечивающей врожденное понимание вязкости жидкости во время движения. Для настоящих патриотов.
...
ent-ClothingEyesEyepatchHudDiagFlipped = диагностическая повязка hud
    .desc = Проекционный дисплей, способный анализировать целостность и состояние робототехники и экзокостюмов. Изготовлен из зеборгия.
...
ent-ClothingEyesEyepatchHudSecurityFlipped = безопасность hud повязка на глазу
    .desc = Проекционный дисплей, который сканирует гуманоидов в поле зрения и предоставляет точные данные об их идентификационном статусе и записях безопасности. Для настоящих патриотов.
...
ent-ClothingEyesHudSyndicateAgent = медицинский щиток синдиката
    .desc = Профессиональный проекционный дисплей санитара Синдиката, предназначенный для быстрой диагностики состояния его команды.
