...
ent-FireAxeCabinetFilled = шкаф для пожарного топора
    .desc = Имеется небольшая этикетка с надписью «Только для экстренного использования» и инструкциями по безопасному использованию топора. Как будто.
    .suffix = Заполненный

ent-FireAxeCabinetFilledOpen = шкаф для пожарного топора
    .desc = Имеется небольшая этикетка с надписью «Только для экстренного использования» и инструкциями по безопасному использованию топора. Как будто.
    .suffix = Заполненный, Открытый

ent-FireAxeCabinetOpen = шкаф для пожарного топора
    .desc = Имеется небольшая этикетка с надписью «Только для экстренного использования» и инструкциями по безопасному использованию топора. Как будто.
    .suffix = Open
