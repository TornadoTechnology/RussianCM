...
ent-CentcommComputerComms = центральный командный компьютер связи
    .desc = Компьютер, используемый для объявления объявлений по всему миру с помощью клавиатуры. Улучшенный родственник обычного коммуникационного компьютера.
...
ent-ComputerCargoOrdersEngineering = компьютер инженерного запроса
    .desc = Используется инженерным отделом для заказа расходных материалов.

ent-ComputerCargoOrdersMedical = компьютер для медицинских запросов
    .desc = Используется медицинским отделом для заказа расходных материалов.

ent-ComputerCargoOrdersScience = компьютер запроса науки
    .desc = Используется научным отделом для заказа расходных материалов.

ent-ComputerCargoOrdersSecurity = компьютер запроса безопасности
    .desc = Используется отделом безопасности для заказа расходных материалов.

ent-ComputerCargoOrdersService = компьютер запроса на обслуживание
...
ent-ComputerFundingAllocation = компьютер распределения финансирования
    .desc = Терминал контроля распределения средств и оплаты по отделениям.
...
ent-ComputerSalvageJobBoard = доска объявлений о спасении
    .desc = Консоль для доступа к работам по утилизации, если вы достаточно выносливы.

ent-ComputerSensorMonitoring = компьютер мониторинга датчиков
    .desc = Гибкая консоль для мониторинга всех видов датчиков.
    .suffix = ТЕСТИРОВАНИЕ, НЕ СОСТАВЛЯЙТЕ КАРТУ
...
ent-WizardComputerComms = компьютер связи мастера
    .desc = Компьютер, способный волшебным образом проецировать вашу речь на станцию. Если вы сделаете объявление, станция предупредит станцию ​​о вашем присутствии.
