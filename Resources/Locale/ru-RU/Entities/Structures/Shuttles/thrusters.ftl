...
ent-GyroscopeUnanchored = гироскоп
    .desc = Увеличивает потенциальный угловой поворот шаттла.
    .suffix = Незакрепленный

ent-RustedThruster = ржавое подруливающее устройство
    .desc = Неремонтопригодное подруливающее устройство, вышедшее из строя из-за износа. Полезно только для списания.
