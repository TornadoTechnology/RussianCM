...
ent-ShuttleGunBase = дерьмовый пистолет
...
ent-ShuttleGunKineticOld = экзоморфный дематериализатор
    .desc = Древняя корабельная пушка, использующая биомеханические системы для хранения и высвобождения энергии. Несмотря на уникальность своей конструкции, он устарел из-за меньшей скорости зарядки и стрельбы по сравнению с механическими конструкциями.
