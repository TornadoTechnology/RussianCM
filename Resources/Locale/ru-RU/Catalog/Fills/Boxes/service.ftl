...
ent-BoxAgrichem = Комплект НТ "АгриХим - это весело"
    .desc = Для начинающих ботаников, готовых узнать, как максимизировать производительность фермы. Этой выцветшей коробке должно быть не менее 50 лет.

ent-BoxCleanerGrenades = коробка для чистки
    .desc = Коробка, полная чисток.

ent-BoxLightbulbColorfulMixed = смешанная красочная коробка с лампочкой
    .desc = Эта коробка имеет такую ​​внутреннюю форму, что в нее помещаются только осветительные трубки и лампочки.

ent-BoxLighttubeColorfulMixed = смешанная красочная коробка для лампочек
    .desc = Эта коробка имеет такую ​​внутреннюю форму, что в нее помещаются только осветительные трубки и лампочки.
