...
ent-BoxBodyBag = коробка для мешка для тела
    .desc = Содержит мешки для трупов.

ent-BoxBottle = коробка для бутылок
    .desc = Коробка, полная пустых бутылок.

ent-BoxLatexGloves = коробка для латексных перчаток
    .desc = В комплекте стерильные латексные перчатки.

ent-BoxNitrileGloves = коробка для нитриловых перчаток
    .desc = В комплект входят стерильные нитриловые перчатки. Лучше, чем латекс.

ent-BoxSterileMask = стерильная коробка для маски
    .desc = В этой коробке находятся стерильные медицинские маски.

ent-BoxVial = коробка для флаконов
