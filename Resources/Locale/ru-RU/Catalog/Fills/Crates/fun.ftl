...
ent-CrateFunArtSupplies = художественные принадлежности
    .desc = Устройте несколько счастливых маленьких происшествий с помощью большого количества мелков!

ent-CrateFunBikeHornImplants = имплантаты велосипедного рога
    .desc = Тысяча гудков в день отпугивает сотрудников службы безопасности!

ent-CrateFunBoardGames = ящик для настольных игр
...
ent-CrateFunDartsSet = набор коробок для дартса
    .desc = Коробка со всем необходимым для веселой игры в дартс.

ent-CrateFunFoamGuns = Ящик Foam Force
    .desc = Содержит четыре винтовки Foam Force, несколько гранат и дополнительные боеприпасы. Либо [УДАЛЕНО], либо ничего!

ent-CrateFunInstrumentsBrass = ящик для ансамбля духовых инструментов
    .desc = Принесите на станцию ​​немного джаза вместе с духовым ансамблем. Содержит множество духовых инструментов, на которых может играть вся станция.

ent-CrateFunInstrumentsKeyedPercussion = Ящик для ансамбля клавишных/ударных инструментов
    .desc = Ударьте по клавишам палочками или руками в этом ящике для ансамбля клавишных и ударных инструментов.

ent-CrateFunInstrumentsSpecial = ящик для коллекционера специальных инструментов
    .desc = Создайте немного шума с помощью этой специальной коллекции спорных инструментов! Centcomm не несет ответственности за любые травмы, вызванные содержанием.

ent-CrateFunInstrumentsString = ящик для ансамбля струнных инструментов
    .desc = Вырви или выдерни, шлепни или порви! Сыграйте плавную мелодию или растопите лица людей с помощью этого набора струнных инструментов.

ent-CrateFunInstrumentsVariety = коллекция эстрадных инструментов
    .desc = Заставьте свою грустную станцию ​​двигаться и веселиться с помощью этого универсального разнообразного набора! Содержит семь различных инструментов.

ent-CrateFunInstrumentsWoodwind = ящик для ансамбля деревянных духовых инструментов
    .desc = Если Atmos хорошо справляется со своей работой, используйте воздух для воспроизведения музыки на этих деревянных духовых инструментах! Настоящее дерево не гарантируется для каждого предмета.

ent-CrateFunLightImplants = легкие имплантаты
    .desc = Осветите свою кожу с помощью этих имплантатов!

ent-CrateFunLizardPlushieBulk = объемный плюшевый ящик для ящерицы
    .desc = Множество мягких плюшевых ящериц. Разбросайте их повсюду, а затем задайтесь вопросом, как вы собираетесь объяснить эту покупку NT.
...
ent-CrateFunParty = ящик для вечеринок
    .desc = Вся компания ждет, пока вы откроете ее. Включает в себя праздничные сувениры, праздничные напитки и даже торт.

ent-CrateFunPirate = пиратский сундук
    .desc = Сундук космического пирата, не для станционных фанатов.
    .suffix = Заполненный

ent-CrateFunPlushie = плюшевый ящик
    .desc = Куча мягких плюшек. Разбросайте их повсюду, а затем задайтесь вопросом, как вы собираетесь объяснить эту покупку NT.

ent-CrateFunSadTromboneImplants = грустные имплантаты тромбона
    .desc = Смерть еще никогда не была такой веселой! Имплантируйте их, чтобы сделать смерть более счастливой.

ent-CrateFunScurret = гидратированная скаррет
    .desc = Подожди, что?

ent-CrateFunSharkPlushieBulk = объемный ящик для мягких игрушек в виде акулы
    .desc = Ящик, наполненный множеством любимых всеми плавниковых друзей. Рорр!

ent-CrateFunToyBox = ящик для игрушек
    .desc = Коробка, полная веселья.
    .suffix = Заполненный

ent-CrateFunWaterGuns = ящик для водяного пистолета
    .desc = Летнее предложение с разнообразными яркими водяными пистолетами. Вода не включена.

ent-CratePlants = ящик для растений
    .desc = Разнообразный набор горшечных растений, которые украсят вашу станцию!
