...
ent-CrateCrusher = ящик дробилки
    .desc = Содержит 2 дробилки для использования в качестве утилизации.

ent-CrateCrusherDagger = ящик с кинжалом дробилки
    .desc = Содержит 4 кинжала-дробилки для использования в качестве утилизации.

ent-CrateCrusherGlaive = ящик с дробилкой
    .desc = Содержит дробящую глефу для использования при разборке.

ent-CrateDoubleEmergencyTank = двойной ящик для аварийного бака
    .desc = Содержит 2 двойных аварийных баллона с кислородом и 2 двойных аварийных баллона с азотом.

ent-CrateFulton = Фултонский ящик
    .desc = Содержит Фултонный маяк и 8 Фултонов.

ent-CratePartsT3 = ящик с деталями 3-го уровня
...
ent-CratePartsT4 = Ящик с деталями 4-го уровня
...
ent-CrateSalvageAssortedGoodies = ящик
    ...
    .suffix = Заполнено, Утилизация Случайная

ent-CrateSalvageEquipment = ящик для аварийного оборудования
    .desc = Для смелых.
    .suffix = Заполненный

ent-CrateSalvageHardsuit = ящик для аварийного костюма
    .desc = В комплект входит спасательный костюм, дыхательная маска и кислородный баллон.

ent-CrateSeismicCharge = ящик с сейсмическим зарядом
    .desc = Содержит 6 сейсмических зарядов для использования при утилизации.

ent-CrateSupremeSalvagerCloak = Ящик с плащом высшего спасателя
    .desc = Содержит плащ, который могут носить только лучшие спасатели. Ношение его незаслуженно приведет к вашей гибели.

ent-CrateVoidJetpack = пустотный ящик с реактивным ранцем
