...
ent-CrateCybersunJuggernautBundle = Джаггернаутный комплект Cybersun
    .desc = Содержит все, кроме большого пистолета для отправки по почте.
    .suffix = Заполненный

ent-CrateSyndicateSuperSurplusBundle = Супер-ящик Синдиката
    .desc = Содержит 125 телекристаллов совершенно случайных предметов Синдиката.

ent-CrateSyndicateSurplusBundle = Ящик с излишками Синдиката
    .desc = Содержит 50 телекристаллов совершенно случайных предметов Синдиката. Это может быть бесполезный хлам или действительно хороший.
