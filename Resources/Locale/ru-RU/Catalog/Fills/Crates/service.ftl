...
ent-CrateServiceJanitorialSupplies = ящик для хозяйственных принадлежностей
    .desc = Боритесь с грязью и сажей с помощью средств для уборки Nanotrasen(tm)! Содержит три ведра, предупреждающие знаки и гранаты-чистильщики. Также имеется швабра, метла, спрей для чистки, проволочная щетка, тряпка и мешок для мусора.
...
ent-CrateTrashCartFilled = мусорная тележка
    .suffix = Заполненный
