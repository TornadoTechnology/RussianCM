...
ent-CrateHydroponicsSeeds = ящик для семян
    .desc = Большие дела имеют маленькое начало. Содержит двенадцать различных семян.

ent-CrateHydroponicsSeedsExotic = ящик для экзотических семян
    .desc = Мечта любого предпринимателя-ботаника. Содержит множество различных экзотических семян. Для открытия требуется доступ к гидропонике.
    .suffix = Безопасный
...
ent-CrateHydroponicsTools = ящик для оборудования для гидропоники
    .desc = Товары для выращивания великолепного сада! Содержит несколько распылителей с химикатами для растений, топор, мини-мотыгу, косу, а также пару кожаных перчаток и фартук ботаника.

ent-CrateHydroponicsTray = ящик для лотков для гидропоники
