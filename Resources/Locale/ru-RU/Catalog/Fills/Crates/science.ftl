...
ent-CrateCrewMonitoring = ящик для наблюдения за экипажем
    .desc = Содержит плоский пакет сервера мониторинга экипажа и несколько компьютеров для мониторинга экипажа. Для открытия требуется доступ к науке.
    .suffix = Безопасный

ent-CrateScienceBiosuit = ящик биологического костюма учёного
    .desc = Содержит 2 костюма биологической защиты, которые гарантируют, что никакая болезнь не отвлечет вас от занятий наукой. Для открытия требуется доступ к науке.
    .suffix = Безопасный
