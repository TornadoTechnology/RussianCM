...
rmc-medical-examine-headless = [color=purple][italic]{CAPITALIZE(SUBJECT($victim))} определённо мёртв.[/italic][/color]
...
rmc-medical-examine-dead-simple-mob = [color=red]{CAPITALIZE(SUBJECT($victim))} МЁРТВ. Отбросил коньки.[/color]

rmc-medical-examine-dead-xeno = [color=red]{CAPITALIZE(SUBJECT($victim))} МЁРТВ. Отбросил коньки. Отправился в великий улей на небесах.[/color]
...
rmc-medical-examine-bleeding-from = [color=#d10a0a]{CAPITALIZE(SUBJECT($victim))} кровоточит из {POSS-ADJ($victim)} {$parts}.[/color]
