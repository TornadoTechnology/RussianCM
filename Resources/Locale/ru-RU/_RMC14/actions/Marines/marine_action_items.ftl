...
ent-ActionToggleCBRNHelmet = Переключить маску ХБРЯ
    .desc = Поднимите или опустите встроенную маску MOPP, чтобы включить полную противопожарную защиту.

ent-RMCActionBroiler = Переключить бак
    .desc = Перейдите на другой топливный бак.

ent-RMCActionDismount = Спешиться
    .desc = Перестаньте использовать оружие

ent-RMCActionToggleExperimentalMesons = Переключить экспериментальные мезонные очки
    .desc = Позволяет получать изображения местности с помощью синтетических мезонов.

ent-RMCActionToggleSynthHud = Переключить синтетический HUD
    .desc = Включите встроенный синтетический медицинский HUD.
