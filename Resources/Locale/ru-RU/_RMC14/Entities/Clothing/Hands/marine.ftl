...
ent-RMCHandsFingerlessMarine = боевые перчатки морпех без пальцев
    .desc = Тактические перчатки морпех стандартного выпуска. Там написано: «вязано Морпех Ассоциацией Вдов». Эти были изменены путем удаления кончиков пальцев.
