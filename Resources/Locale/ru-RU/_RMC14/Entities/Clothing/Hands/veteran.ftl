...
ent-RMCHandsVeteranPMCCommandoSurvivor = Перчатки We-Ya Commando
    .desc = Стандартные перчатки из кевлонового волокна, изготовленные для компании Weston-Yamada Commandos. Они изолированы от поражения электрическим током.

ent-RMCHandsVeteranSPP = бронированные перчатки
    .desc = Нестандартные перчатки из кевлонового волокна. Они изолированы и тяжелобронированы.
