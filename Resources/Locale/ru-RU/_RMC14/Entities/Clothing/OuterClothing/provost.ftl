...
ent-RMCArmorProvostSeniorFilled = Броня старшего проректора образца М3
    .desc = Более изысканная нагрудник модели «Провост» M3 для старших офицеров. Защищает грудь от баллистических снарядов, острых предметов и несчастных случаев. К нему прикреплен небольшой кожаный мешочек для ограниченного хранения.
