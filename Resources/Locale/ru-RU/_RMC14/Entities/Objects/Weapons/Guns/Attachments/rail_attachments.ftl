...
ent-RMCAttachmentL89Scope = L89 интегрированная оптика
    .desc = Винтовка примерно так же полезна, как и ты сейчас, придурок. Положите его обратно.

ent-RMCAttachmentS5MicroRedDotSight = S5-микроточечный прицел
    .desc = Легкая низкопрофильная точечная оптика, предназначенная для быстрого обнаружения цели с минимальными потерями в весе. Оптимизированный для пистолетов-пулеметов и личного оружия, он идеально подходит для ближнего боя, где скорость и ловкость имеют наибольшее значение.

ent-RMCAttachmentSASOS = L91O1 САСОС
    .desc = Интеллектуальный оптический прицел для стрелкового оружия, или SASOS, производства TSE, представляет собой экспериментальную оптику следующего поколения с поддержкой IFF, разработанную для использования в составе системы вспомогательного вооружения L91.

ent-RMCAttachmentScopeBase = item

ent-RMCAttachmentScopeMGLIntegrated = Коллиматорный прицел L989A2 в сборе
    .desc = Черт возьми... Я думаю, это должно быть приклеено...

ent-RMCL112IntegratedScope = Встроенный прицел L112O1
    .desc = Черт возьми! Я не думаю, что этот наконечник должен был оторваться от винтовки...
