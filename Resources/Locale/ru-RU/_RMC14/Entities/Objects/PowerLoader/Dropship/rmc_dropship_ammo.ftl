...
ent-AU14DropshipAttachmentAmmoCBU250 = CBU-250 «Обеденный спред»
    .desc = CBU-250 «Dinner Spread» — кассетный боеприпас, предназначенный для использования против легкобронированной техники и пехоты противника. При развертывании боеприпас разделяется на двенадцать маломощных бомб, неравномерно рассеивая их по большой площади. Его можно загрузить в пусковую установку управляемых ракет ЛАУ-444.

ent-AU14DropshipAttachmentAmmoCBU607 = CBU-607 Стойка для стрельбы по тарелочкам
    .desc = CBU-607 «Skeet Shooter» представляет собой кассетную боеукладку с четырьмя ракетами, предназначенную для использования против средней бронетехники и пехоты противника. При развертывании каждый боеприпас разделяется на две бомбы средней мощности, плотно распределяя их по небольшой площади. Его можно загрузить в пусковую установку управляемых ракет ЛАУ-444.

ent-AU14DropshipAttachmentAmmoGBU89I = GBU-89C/N «Горящий почтальон»
    .desc = Совместный боеприпас прямой атаки GBU-89B/Napalm — старый, но надежный управляемый боеприпас большого размера. У него чрезвычайно долгое время пути, но он может сровнять с землей и поджечь целые здания. Его можно загрузить в пусковую установку управляемых ракет ЛАУ-444.

ent-AU14DropshipAttachmentAmmoMk102JDAM = ГБУ-89Б «Почтальон»
    .desc = Боеприпас прямого нападения GBU-89B — старый, но надежный управляемый боеприпас большого размера. У него слишком долгое время пути, но он может сровнять с землей целые здания. Его можно загрузить в пусковую установку управляемых ракет ЛАУ-444.

ent-AU14DropshipAttachmentAmmoRocketBansheeHorde = Стойка AIM-207 «Абордажная сабля»
    .desc = Четырехзарядная пусковая установка ракет AIM-207 «Абордаж», модифицированная для ударов по земле. Первоначально являвшаяся ракетой класса «воздух-воздух», Cutlass была адаптирована с упрощенным пакетом наведения и боеголовкой с неконтактным взрывателем, что позволяло рассредоточить все четыре ракеты по широкой схеме насыщения над обозначенной целевой областью. Его можно загрузить в пусковую установку управляемых ракет ЛАУ-444.

ent-AU14DropshipAttachmentAmmoRocketThermobaricTwo = BLU-176 «Избыточное давление»
    .desc = BLU-176 «Избыточное давление» — термобарическая топливно-воздушная бомба, меньшая версия BLU-200 «Дыхание дракона». Аэрозольная топливная смесь при воспламенении создает вакуум, вызывая серьезные повреждения всего на своем пути. Его можно загрузить в пусковую установку управляемых ракет ЛАУ-444.

ent-AU14DropshipAttachmentAmmoRocketWidowmakerDouble = Стойка AIM-224B «Двойная вдова»
    .desc = Двухзарядная пусковая установка ракеты AIM-224B. Получил прозвище «Двойная вдова» из-за того, что это два Создателя вдов, поставленные друг на друга. Обе ракеты запускаются одновременно и действуют крайне непредсказуемо. Не очень подходит для наземной бомбардировки, но благодаря высокой скорости он быстро достигает цели. Эта бомба была модифицирована в двухзарядную свободнопадающую бомбу из-за нехватки боеприпасов на десантном корабле. Возможна установка в пусковую установку управляемого ракетного вооружения ЛАУ-444.

ent-AU14DropshipAttachmentAmmoRocketWidowmakerDoubleADMIN = AIM-224A «Восьмеричная вдова» (НЕ НАносить на карту)
    .desc = Ракета AIM-224A представляет собой модернизацию новейшей ракетной технологии класса «воздух-воздух». Получил прозвище «Двойная вдова» из-за того, что это два Создателя вдов, поставленные друг на друга. Обе ракеты запускаются одновременно и действуют крайне непредсказуемо. Не очень подходит для наземной бомбардировки, но благодаря высокой скорости он быстро достигает цели. Эта бомба была модифицирована в двухзарядную свободнопадающую бомбу из-за нехватки боеприпасов на десантном корабле. Возможна установка в пусковую установку управляемого ракетного вооружения ЛАУ-444.

ent-AU14EffectExplosionParticleJDAM = взрыв

ent-AU14SmokeExplosionProofJDAM = курить

ent-RMCDropshipAttachmentAmmoLaunchableSentry = Воздушный сторожевой самолет A/C-49-P
    .desc = Всенаправленный часовой, способный защитить территорию от вторжения легкобронированной техники. Может быть загружен во внутреннюю турельную установку ЛАГ-14.
