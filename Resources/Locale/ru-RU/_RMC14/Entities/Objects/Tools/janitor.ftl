...
ent-RMCLightReplacer = заменитель света
    .desc = Устройство для автоматической замены ламп. Заправьте рабочие лампочки.

ent-RMCLightReplacerEmpty = заменитель света
    .desc = Устройство для автоматической замены ламп. Заправьте рабочие лампочки.
    .suffix = Пустой

ent-RMCSprayBottleSpaceCleaner = заменитель света
    .desc = Устройство для автоматической замены ламп. Заправьте рабочие лампочки.
    .suffix = Пустой
