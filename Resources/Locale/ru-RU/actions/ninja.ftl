...
ent-ActionCreateThrowingStar = Создать метательную звезду
    .desc = Каналы преобразуют силу в создание метательной звезды, наносящей дополнительный урон выносливости.

ent-ActionEnergyKatanaDash = Катана тире
...
ent-ActionRecallKatana = Вспомнить катану
...
ent-ActionToggleNinjaGloves = Переключить перчатки ниндзя
    .desc = Переключает все действия в перчатках при левом щелчке мыши. Включает в себя дверной домкрат, истощение энергии, оглушение врагов и взлом определенных компьютеров.
