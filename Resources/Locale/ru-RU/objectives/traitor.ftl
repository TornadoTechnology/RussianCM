...
ent-EscapeShuttleObjective = Сбегите в Центкомм живым и безудержным.
    .desc = Когда вы приедете, один из наших агентов под прикрытием допросит вас. Не появляйтесь в наручниках.
