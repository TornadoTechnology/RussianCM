...
ent-ParadoxCloneKillObjective = Исправьте парадокс пространства-времени.
    .desc = Замените оригинал, чтобы исправить парадокс. Помните, ваша миссия — сливаться с толпой, не убивайте никого, кроме случаев крайней необходимости!

ent-ParadoxCloneLivingObjective = Сбегите в Центкомм живым и безудержным.
