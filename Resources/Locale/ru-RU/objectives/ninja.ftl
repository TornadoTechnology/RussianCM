...
ent-MassArrestObjective = Установить всех в розыск
    .desc = Используйте свои перчатки, чтобы взломать консоль криминального учета и объявить в розыск всю станцию!

ent-NinjaSurviveObjective = Выживать
    .desc = Если бы ты умер, ты бы не стал хорошим ниндзя, не так ли?

ent-TerrorObjective = Звонок с угрозой
    .desc = Используйте перчатки на консоли связи, чтобы принести на станцию ​​еще одну угрозу.
