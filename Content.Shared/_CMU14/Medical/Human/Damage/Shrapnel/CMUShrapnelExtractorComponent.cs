...
public sealed partial class CMUShrapnelExtractorComponent : Component
{
    ...
    [DataField]
    public float AssistedDelayMultiplier = 0.65f;

    [DataField]
    public float DeepDelayMultiplier = 1.75f;

    [DataField]
    public float DeepDamageMultiplier = 2f;

    [DataField]
    public float DeepPainMultiplier = 1.5f;
